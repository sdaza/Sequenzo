"""
简化版单元测试：测试 get_distance_matrix 在重复序列多/不多情况下的性能表现
不依赖外部包，只使用标准库
序列规模扩展到4万
"""
...
class TestGetDistanceMatrixPerformanceSimple(unittest.TestCase):
    """测试 get_distance_matrix 在不同重复序列情况下的性能（简化版）"""
...
def run_simple_performance_tests():
    """运行简化版性能测试"""
    print("开始运行 get_distance_matrix 大规模简化版性能测试...")
    print("="*80)
    ...
    for test_case in test_cases:
        suite.addTest(TestGetDistanceMatrixPerformanceSimple(test_case))
