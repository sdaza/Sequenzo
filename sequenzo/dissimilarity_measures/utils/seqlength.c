...
#define __pyx_n_u_to_numpy __pyx_string_tab[35]
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  {
    __Pyx_PyCode_New_function_description descr = {1, 0, 0, 2, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 7, 105};
    PyObject* varnames[] = {__pyx_mstate->__pyx_n_u_seqdata, __pyx_mstate->__pyx_n_u_seqarray_long};
